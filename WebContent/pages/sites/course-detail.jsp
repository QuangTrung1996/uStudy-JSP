  ...
  <div class="contentContainer container-fluid">
    <div class="nav-links">
      <ol class="breadcrumb">
        ...
        <li><a href="all-courses.html">Danh sách khoá học</a></li>
    ...
    <div class="row">
      <div class="course-banner col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
        <div class="col-md-8 col-sm-12 col-xs-12">
          ...
          <a href="#" class="btn btn-primary disabled" onclick="alert('Vui lÃ²ng ÄÄng nháº­p Äá» sá»­ dá»¥ng tÃ­nh nÄng nÃ y');">ÄÄng kÃ­ há»c</a>
        </div>
