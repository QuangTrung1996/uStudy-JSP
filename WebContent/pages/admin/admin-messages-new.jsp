    ...
    <div class="container-fluid">
      ...
      <div class="nav-links">
        <ol class="breadcrumb">
          ...
          <li><a href="admin-messages.jsp">Tin nhắn</a></li>
        ...
        <div class="messages-container col-md-6 col-md-offset-3" style="border:1px solid;background-color:#f9f9f9;padding:15px;">
          <form action="" class="form-horizontal">
            <div class="form-group">
              <label class="control-label col-sm-3" for="receiverID">Người nhận: </label>
              <div class="col-sm-9">
                <input type="text" class="form-control" id="receiverID">
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-sm-3" for="textMessage">Nội dung: </label>
              <div class="col-sm-9">
